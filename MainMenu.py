...
class Main_menu(tkinter.Frame):
    def __init__(self, master,*args, **kwargs):
        ...
        self.master = master
        self.heading = Label(master, text="PHARMACY MANAGEMENT SYSTEM", font=('arial 40 bold'), fg='steelblue')
...
class dealer(tkinter.Frame):
    def __init__(self, master,controller, *args, **kwargs):
        tkinter.Frame.__init__(self, master)
        self.master = master
        self.heading = Label(master, text="DEALERS", font=('arial 40 bold'), fg='steelblue')
        ...
        self.btn_D_srcname = Button(master, text="Search", font=('arail 13 bold'), width=10, height=1,
                                    bg="steelblue", fg='white', command=self.search_name)
        ...
        self.btn_D_list = Button(master, text="Go to menu", font=('arail 13 bold'), width=18, height=2,bg="steelblue", fg='white', command=self.dealer_list)
    ...
    def search_name(self, *args, **kwargs):
        ...
        for x in rows:
            ...
            fx3 = str(x[2])
            fx4 = str(x[3])
            self.tBox.insert(END, ("   " + fx1 + " " * (10 - len(fx1)) + "| " + fx2 + " " * (
                    16 - len(fx2)) + "| " + fx3 + " " * (16 - len(fx3)) + "| " + fx4))
