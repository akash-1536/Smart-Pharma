...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.heading = Label(master, text="INVENTORY", font=('arial 40 bold'), fg=('steelblue'))
        ...
        self.btn_view = Button(master, text="VIEW THE INVENTORY", width=30, height=2, bg="lightgreen", fg="white", command=self.inventory_list)
